...
public class FeignClientConfiguration {
    ...
    private static String KEY_STORE_PATH = "paypal-service/src/main/resources/paypal.keystore.p12";

    private static String TRUST_STORE_PATH = "paypal-service/src/main/resources/paypal.truststore.p12";
