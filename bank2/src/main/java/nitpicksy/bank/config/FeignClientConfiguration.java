...
public class FeignClientConfiguration {
    ...
    private static String KEY_STORE_PATH = "bank2/src/main/resources/bank.keystore.p12";

    private static String TRUST_STORE_PATH = "bank2/src/main/resources/bank.truststore.p12";
