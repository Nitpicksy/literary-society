        ...
        <Container component="main" maxWidth="md">
            ...
            <div className={classes.paper}>
                ...
                <Grid container spacing={3} align="center">
                    <SignUpOptionCard title="Reader" path="/sign-up" type="readers" smColumns={6} xsColumns={12}
                        description="Readers can purchase and download books. Additionally, beta-readers can review writers' manuscripts." />
                    <SignUpOptionCard title="Writer" path="/sign-up" type="writers" smColumns={6} xsColumns={12}
