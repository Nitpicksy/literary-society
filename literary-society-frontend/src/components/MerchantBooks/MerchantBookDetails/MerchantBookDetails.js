...
import * as actions from './MerchantBookDetailsActions';
...
import { useStyles } from './MerchantBookDetailsStyles';
import { connect } from 'react-redux';
import { useHistory } from 'react-router';
import Image from 'material-ui-image';
import {  Chip, Paper, Tooltip } from '@material-ui/core';

const MerchantBookDetails = (props) => {
    ...
    if (!loading && props.bookDetails) {
        ...
        <div>
            ...
            <Typography component="h1" variant="h4">Your book</Typography>
        </div>;
    }
...
const mapStateToProps = state => {
    return {
        bookDetails: state.merchantBook.book
    }
};
...
export default connect(mapStateToProps, mapDispatchToProps)(MerchantBookDetails);