insert into company (uri, common_name, company_name, email, error_url, failed_url, success_url, certificate_name,
                     status, enabled)
values ('https://192.168.43.199:8090', 'literary-society', 'Nitpicksy LU 1', 'literary@maildrop.cc',
...
insert into data_for_payment (attribute_name, attribute_value, merchant_id, payment_method_id, data_id)
values ('merchantClientId',
        'HjrUQgJ3UlgMAA8IxiuLp8M7y3j0LcqN6qW26wtgiw3kq/v/7sgQH6vflrM9fdogUDuzOsUiLE45Vyf2rMOCNpPSgT5BaA1blEYJDQ0PwD9zMP6fYEkAmxjLFmZkBx2X',
        1, 2, 3);
insert into data_for_payment (attribute_name, attribute_value, merchant_id, payment_method_id, data_id)
values ('merchantClientSecret',
        '1bMOqvW9nhI12qIWoNcS0JQFqysx5oH/70/RNpHNpNmP8wEMOYv3Sl4tf6IFRecCY67shanoz8rCSnVB086qswNjHSLjjT+lIRVq3EiMc+FzMP6fYEkAmxjLFmZkBx2X',
        1, 2, 4);
...
insert into data_for_payment (attribute_name, attribute_value, merchant_id, payment_method_id, data_id)
values ('merchantClientId',
        'ZhDqYXnp6f08ZSk8fhDqiXUUijfLSLOUNsMDhtCHeRYpF2ZwLmW75lCImvuV9SZvuQLkgmr7DrU/doAyWbd+DD0SK8xkTTerpm4YONqr561zMP6fYEkAmxjLFmZkBx2X',
        2, 2, 3);
insert into data_for_payment (attribute_name, attribute_value, merchant_id, payment_method_id, data_id)
values ('merchantClientSecret',
        'gaPuXYOoJbl6ius3H9cM3SiR+1WCM6twEnz4ZZwOMN4fj02diM26ECJEUCOYTGby+GRia/BMiJ9TzgTBt8sa5jXR51TVtzvFgLnaeDYo4OBzMP6fYEkAmxjLFmZkBx2X',
        2, 2, 4);
...
insert into data_for_payment (attribute_name, attribute_value, merchant_id, payment_method_id, data_id)
values ('merchantClientId',
        'peqGo1stDYXqMsel3LPL1Xv4XRLDuMeij6ROyRQDLquJctqb2dgY6o/Zp9rHXy6U7spWS6YGm+X1g2SmKPPLTzydegBBzleOFfNpuIrLOhdzMP6fYEkAmxjLFmZkBx2X',
        3, 2, 3);
insert into data_for_payment (attribute_name, attribute_value, merchant_id, payment_method_id, data_id)
values ('merchantClientSecret',
        'hty26ltyxHZ7itEDMr9SXE2ezIDDVgsJLdDJxldV9Q8Z1XGAiR/ywdNKAs8jPBunbJBcJyezSvQcAAtgAgEv1efFBFenLOm+A1UbL9dYmolzMP6fYEkAmxjLFmZkBx2X',
        3, 2, 4);
