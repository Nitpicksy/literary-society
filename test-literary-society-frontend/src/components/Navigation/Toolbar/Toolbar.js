...
const CustomToolbar = (props) => {
  ...
  if (
    ...
    (checkRole(roleWriter) ||
      checkRole(roleEditor) ||
      checkRole(roleReader) ||
      checkRole(roleLecturer) ||
      checkRole(roleCommitteeMember))
  ) {
    tasks = (
      <Button
  ...
  let toolbarItems = (
    <React.Fragment>
      <Button color="inherit" onClick={() => redirect("/sign-in")}>
        Sign in
      </Button>
      <Button color="inherit" onClick={() => redirect("/sign-up-options")}>
        Sign up
      </Button>
    </React.Fragment>
  );
  ...
  if (props.isAuthenticated) {
    toolbarItems = (
      <React.Fragment>
        ...
        >
          <MenuItem onClick={() => redirect("/change-password")}>
            Change password
          </MenuItem>
        </Menu>
    ...
    <AppBar position="static" style={{ backgroundColor: "darkgreen" }}>
      <Toolbar variant="dense">
        ...
        <Button
          className={classes.button}
          color="inherit"
          onClick={() => redirect("/shopping-cart")}
        >
          Shopping Cart
        </Button>
        {toolbarItems}
