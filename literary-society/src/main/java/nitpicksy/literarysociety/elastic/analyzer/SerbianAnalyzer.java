package nitpicksy.literarysociety.elastic.analyzer;

import nitpicksy.literarysociety.elastic.filter.LatCyrFilter;
import nitpicksy.literarysociety.elastic.filter.RemoveAccentsFilter;
import nitpicksy.literarysociety.elastic.plugin.SerbianStemmer;
