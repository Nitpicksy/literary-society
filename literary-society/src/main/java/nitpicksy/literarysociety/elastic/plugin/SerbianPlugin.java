...
package nitpicksy.literarysociety.elastic.plugin;

import nitpicksy.literarysociety.elastic.analyzer.SerbianAnalyzerProvider;
import nitpicksy.literarysociety.elastic.analyzer.SerbianTokenFilterFactory;
...
public class SerbianPlugin extends Plugin implements AnalysisPlugin {
    ...
    public Map<String, AnalysisProvider<TokenFilterFactory>> getTokenFilters() {
        AnalysisProvider<TokenFilterFactory> value =
                (indexSettings, environment, name, settings) ->
                        new SerbianTokenFilterFactory(indexSettings, name, settings);
    ...
    public Map<String, AnalysisProvider<AnalyzerProvider<? extends Analyzer>>> getAnalyzers() {
        ...
        AnalysisProvider<AnalyzerProvider<? extends Analyzer>> value =
                (indexSettings, environment, name, settings) ->
                        new SerbianAnalyzerProvider(indexSettings, name, settings);
