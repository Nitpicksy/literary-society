package nitpicksy.literarysociety.elastic.config;

import nitpicksy.literarysociety.elastic.plugin.SerbianPlugin;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "nitpicksy.literarysociety.elastic.repository")
public class ElasticsearchConfiguration {
    ...
    public Client nodeClient() {
        ...
        Settings settings = Settings.builder()
                ...
                .put("cluster.name", "literary-society-nbrodic")
