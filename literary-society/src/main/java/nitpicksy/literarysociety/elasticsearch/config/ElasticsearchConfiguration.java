...
import nitpicksy.literarysociety.elasticsearch.plugin.SerbianPlugin;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "nitpicksy.literarysociety.elasticsearch.repository")
public class ElasticsearchConfiguration {
    ...
    public Client nodeClient() {
        ...
        Settings settings = Settings.builder()
                ...
                .put("cluster.name", "literarySocietyNode")
