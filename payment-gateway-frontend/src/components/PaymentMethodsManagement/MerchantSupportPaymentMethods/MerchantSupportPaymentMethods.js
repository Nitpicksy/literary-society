...
const MerchantSupportPaymentMethods = (props) => {
    ...
    if (controls) {
        form = <MerchantSupportPaymentMethodsForm controls={controls} setControls={setControls} setFormIsValid={setFormIsValid} />;
    }
    ...
    return (
        <Container component="main" maxWidth="xs">
            ...
            <Paper className={classes.mainPaper}>
                ...
                <Typography component="h1" variant="h4" className={classes.title}>Support Payment Methods</Typography>
...
export default connect(mapStateToProps, mapDispatchToProps)(MerchantSupportPaymentMethods);